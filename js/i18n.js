        ...
        try {
            ...
            const zhCN = {
                ...
                version: {
                    ...
                    dataQueryRetention: '历史数据查询天数',
                    dataQueryTip: '历史数据的查询保留时间',
                    otherSettings: '其他配置',
            ...
            const enUS = {
                ...
                version: {
                    ...
                    dataQueryRetention: 'Historical Data Query Days',
                    dataQueryTip: 'Query retention time for historical data',
                ...
                menuConfig: {
                    ...
                    typeDescTab: 'Tab: Permission control for tab pages',
